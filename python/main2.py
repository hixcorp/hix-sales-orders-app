...
@app.get("/get_all_item_settings", response_model=List[ItemSettings])
...
def update_item_settings_by_column_names(update_items:UpdateItemSettings, db: Session = Depends(get_local_database)):
